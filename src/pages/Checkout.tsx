...
const steps = ['Endereço de entrega', 'Dados de pagamento', 'Revisar pedido'];
...
export default function Checkout(props: { disableCustomTheme?: boolean }) {
    ...
    return (
        <AppTheme {...props}>
            ...
            >
                {/* Painel esquerdo — resumo do pedido (desktop) */}
                <Grid
                ...
                >
                    ...
                    >
                        ...
                        {/* Tela de confirmação ou etapas */}
                        {activeStep === steps.length ? (
                            <Stack spacing={2} useFlexGap>
                                <Typography variant="h1">📦</Typography>
                                <Typography variant="h5">Obrigado pelo seu pedido!</Typography>
                                <Typography variant="body1" sx={{ color: 'text.secondary' }}>
                                    Seu número de pedido é <strong>#140396</strong>. Enviamos a confirmação por email e avisaremos quando seu pedido for despachado.
                                </Typography>
                                <Button
                                    variant="contained"
