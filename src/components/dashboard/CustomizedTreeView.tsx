// src/components/dashboard/CustomizedTreeView.tsx
...
const ITEMS: TreeViewBaseItem<ExtendedTreeItemProps>[] = [
  {
    ...
    label: 'Eletrônicos',
    children: [
      { id: '1.1', label: 'Notebooks', color: 'green' },
      { id: '1.2', label: 'Smartphones', color: 'green' },
      { id: '1.3', label: 'Acessórios', color: 'green' },
    ],
  },
  {
    id: '2',
    label: 'Roupas',
    children: [
      { id: '2.1', label: 'Camisetas', color: 'green' },
      { id: '2.2', label: 'Calças', color: 'green' },
      { id: '2.3', label: 'Calçados', color: 'green' },
    ],
  },
  { id: '3', label: 'Acessórios', color: 'blue' },
  { id: '4', label: 'Outros', color: 'blue' },
];
