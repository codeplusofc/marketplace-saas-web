                ...
                <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                  <AccountBalanceRoundedIcon
                      ...
                      sx={[
                        ...
                        paymentType === 'bankTransfer' && { color: 'primary.main' },
                      ]}
                  />
                  <Typography sx={{ fontWeight: 'medium' }}>Transferência bancária</Typography>
                </CardContent>
              </CardActionArea>
            </Card>
          </RadioGroup>
        ...
        {paymentType === 'creditCard' && (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <FormControlLabel
                  ...
                  label="Salvar dados do cartão para a próxima compra"
              />
            </Box>
        )}
